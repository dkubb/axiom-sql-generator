...
describe SQL::Generator::Relation::Insertion, '#visit_veritas_relation_operation_insertion' do
  subject { object.visit_veritas_relation_operation_insertion(insertion) }
