...
describe Generator::Relation::Unary, '#visit_veritas_algebra_rename' do
  ...
  context 'when the operand is a rename' do
    ...
    context 'when the operand is empty' do
      ...
      its(:to_inner) { should eql('SELECT "id" AS "user_id", "name", "age" FROM (SELECT "id", "name", "age" FROM "users") AS "users"') }
    end
  end
  ...
  context 'when the operand is a join' do
    ...
    its(:to_inner) { should eql('SELECT "id" AS "user_id", "name", "age" FROM (SELECT * FROM "users" NATURAL JOIN "users") AS "users"') }
  end
end
