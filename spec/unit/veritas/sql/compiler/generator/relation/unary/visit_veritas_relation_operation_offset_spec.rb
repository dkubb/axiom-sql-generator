...
describe Generator::Relation::Unary, '#visit_veritas_relation_operation_offset' do
  ...
  context 'when the operand is a base relation' do
    ...
    its(:to_inner) { should eql('SELECT * FROM "users" ORDER BY "id", "name", "age" OFFSET 1') }
  end
  ...
  context 'when the operand is a projection' do
    ...
    its(:to_inner) { should eql('SELECT DISTINCT "id", "name" FROM "users" ORDER BY "id", "name" OFFSET 1') }
  end
  ...
  context 'when the operand is a restriction' do
    ...
    its(:to_inner) { should eql('SELECT * FROM "users" WHERE "id" = 1 ORDER BY "id", "name", "age" OFFSET 1') }
  end
  ...
  context 'when the operand is reversed' do
    ...
    its(:to_inner) { should eql('SELECT * FROM "users" ORDER BY "id" DESC, "name" DESC, "age" DESC OFFSET 1') }
  end
  ...
  context 'when the operand is limited' do
    ...
    its(:to_inner) { should eql('SELECT * FROM (SELECT * FROM "users" ORDER BY "id", "name", "age" LIMIT 1) AS "users" OFFSET 1') }
  end
  ...
  context 'when the operand is an offset' do
    ...
    context 'when the relation is not optimized' do
      ...
      its(:to_inner) { should eql('SELECT * FROM (SELECT * FROM "users" ORDER BY "id", "name", "age" OFFSET 1) AS "users" OFFSET 1') }
    end
    ...
    context 'when the relation is optimized' do
      ...
      its(:to_inner) { should eql('SELECT * FROM "users" ORDER BY "id", "name", "age" OFFSET 2') }
    end
  end
  ...
  context 'when the operand is a difference' do
    ...
    its(:to_inner) { should eql('SELECT * FROM ((SELECT * FROM "users" ORDER BY "id", "name", "age") EXCEPT (SELECT * FROM "users" ORDER BY "id", "name", "age")) AS "users" OFFSET 1') }
  end
  ...
  context 'when the operand is an intersection' do
    ...
    its(:to_inner) { should eql('SELECT * FROM ((SELECT * FROM "users" ORDER BY "id", "name", "age") INTERSECT (SELECT * FROM "users" ORDER BY "id", "name", "age")) AS "users" OFFSET 1') }
  end
  ...
  context 'when the operand is a join' do
    ...
    its(:to_inner) { should eql('SELECT * FROM (SELECT * FROM (SELECT * FROM "users" ORDER BY "id", "name", "age") AS "left" NATURAL JOIN (SELECT * FROM "users" ORDER BY "id", "name", "age") AS "right") AS "users" OFFSET 1') }
  end
end
