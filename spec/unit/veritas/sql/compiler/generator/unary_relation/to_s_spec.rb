...
describe Generator::UnaryRelation, '#to_s' do
  ...
  context 'when a restriction is visited' do
    ...
    its(:to_s) { should == 'SELECT DISTINCT "users"."id", "users"."name", "users"."age" FROM "users" WHERE "users"."id" = 1' }
  end
  ...
  context 'when a limit is visited' do
    ...
    its(:to_s) { should == 'SELECT DISTINCT "users"."id", "users"."name", "users"."age" FROM "users" ORDER BY "users"."id", "users"."name", "users"."age" LIMIT 1' }
  end
  ...
  context 'when an offset is visited' do
    ...
    its(:to_s) { should == 'SELECT DISTINCT "users"."id", "users"."name", "users"."age" FROM "users" ORDER BY "users"."id", "users"."name", "users"."age" OFFSET 1' }
  end
end
